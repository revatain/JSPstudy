...
implements ActionListener{
	...
	public ChatUI(String roomname,BufferedReader in, PrintWriter out, String id) {	// 답변할 사람의 채팅방
	...
	public ChatUI(String roomname,BufferedReader in, PrintWriter out, String id, int owner) { // 질문 한사람의 채팅방
		System.out.println("방생성");
		setSize(450, 500);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		this.roomName = roomname;
